...
% sum_fig = create_summary_cluster_fig(clusterDetails,Spikes,spike_xy,params)
% creates summary figure of spike clustering
...
%% AVG WAVEFORMS
if N_chs > 1 %if using multiple channels just make error bar plots
...
else %for single channel show all spikes
    subplot(2,3,3); hold on
    n_show = 250;
...
%% Time v X plot (this plot can be slow, might leave out)
